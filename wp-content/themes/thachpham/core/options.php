<?php
    ...
    //args liên quan đến các phần thiết lập
    $args = array(
    ...
    ThachPham_Theme_Options::setArgs( $opt_name, $args );
    ...
    ThachPham_Theme_Options::setHelpTab( $opt_name, $tabs );

    // Set the help sidebar
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'redux-framework-demo' );
    ThachPham_Theme_Options::setHelpSidebar( $opt_name, $content );
    ...
    // -> START Basic Fields
    ThachPham_Theme_Options::setSection( $opt_name, array(
