...
function tp_remove_hook(){

	remove_action( 'woocommerce_before_main_content','woocommerce_breadcrumb',20 );
}
// sẽ chạy cái hàm này khi được load 
add_action('init','tp_remove_hook', 20 );
function tp_sale_flash($output)
{
	$output='<span class="onsale">' . esc_html__( 'Giảm Giá', 'woocommerce' ) . '</span>';
	return $output;
}
